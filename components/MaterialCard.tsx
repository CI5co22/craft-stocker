      ...
      >
        ...
        <div className="absolute top-2 right-2 z-10 flex gap-1 opacity-100 md:opacity-0 group-hover:opacity-100 transform translate-y-1 group-hover:translate-y-0 transition-all duration-200">
          <button 
            ...
            className="p-1.5 bg-white/95 text-slate-400 hover:text-emerald-600 rounded-full shadow-sm border border-slate-100 hover:border-emerald-100 transition-all active:scale-90"
          ...
          <button 
            ...
            className="p-1.5 bg-white/95 text-slate-400 hover:text-red-500 rounded-full shadow-sm border border-slate-100 hover:border-red-100 transition-all active:scale-90"
